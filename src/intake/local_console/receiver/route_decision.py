...
class UploadRouteDecision(BaseUploadRouteDecision):
    ...
    receiver_handshake_latency_ms: float | None = None
    receiver_endpoint: str | None = None
...
class UploadRouteDecisionService:
    ...
    def __init__(self, receiver_service: LocalReceiverService | None = None):
        ...
        self._fallback_provider: UploadProviderKind | None = None
    ...
    def get_fallback_provider(self) -> UploadProviderKind | None:
    ...
    ) -> tuple[bool, ReceiverHandshakeResponse | None]:
